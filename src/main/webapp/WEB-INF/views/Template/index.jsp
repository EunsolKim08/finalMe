...
<html lang="en">
  ...
  <head>
    ...
    <!-- Your page title -->
    <title>Faith in Christ Church</title>
          ...
          <div class="promotion">
            <div class="row align-items-center">
              <div class="flex-md-6 flex-lg-9 text-center-sm text-left-md">
                <p>Get the full version with more functionalities, pages, and features at Template Monster
                </p>
              </div>

              <div class="flex-md-6 flex-lg-3">
                <a href="https://www.templatemonster.com/website-templates/faith-in-christ-church-christian-church-website-template-118518.html?_gl=1*1n6aq9e*_ga*MTQwODAzODI5OS4xNjE3NDkzMTkz*_ga_FTPYEGT5LY*MTYyNDE0NjEwMy43NS4xLjE2MjQxNDYxMDUuNTg.&_ga=2.233450718.1907862184.1623810204-1408038299.1617493193"
                  class="button button--promotion button-block-sm button-inline-lg">Get full version</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="welcome__content">
          ...
          <div class="container">
            ...
            <div class="welcome__image">
              <img src="images/praying-girl.png" alt="A girl praying">
            </div>
              ...
              <div class="flex-md-6 flex-lg-4">
                ...
                <div class="card cause">
                  ...
                  <div class="card__header no-overlay">
                    ...
                    <img src="images/causes-3.jpg" alt="" class="card__image">
              ...
              <div class="flex-md-6 flex-lg-4">
                ...
                <div class="card cause">
                  ...
                  <div class="card__header no-overlay">
                    ...
                    <img src="images/cause-1.jpg" alt="" class="card__image">
              ...
              <div class="flex-md-12 flex-lg-4 mar-t-md-2 mar-t-lg-0">
                ...
                <div class="card cause">
                  ...
                  <div class="card__header no-overlay">
                    ...
                    <img src="images/causes-2.jpg" alt="" class="card__image">
                ...
                <div class="flex-md-6 flex-lg-4">
                  ...
                  <div class="card staff">
                    ...
                    <div class="card__header no-overlay">
                      ...
                      <img src="images/user-5.jpg" alt="" class="card__image">
                ...
                <div class="flex-md-6 flex-lg-4">
                  ...
                  <div class="card staff">
                    ...
                    <div class="card__header no-overlay">
                      ...
                      <img src="images/user-2.jpg" alt="" class="card__image">
                ...
                <div class="flex-md-12 flex-lg-4 mar-t-md-2 mar-t-lg-0">
                  ...
                  <div class="card staff">
                    ...
                    <div class="card__header no-overlay">
                      ...
                      <img src="images/user-4.jpg" alt="" class="card__image">
                ...
                <div class="flex-md-6 flex-lg-4">
                  ...
                  <div class="card blog">
                    ...
                    <div class="card__header">
                      ...
                      <img src="images/blog-1.jpg" alt="" class="card__image">
                ...
                <div class="flex-md-6 flex-lg-4">
                  ...
                  <div class="card blog">
                    ...
                    <div class="card__header">
                      ...
                      <img src="images/blog-2.jpg" alt="" class="card__image">
                ...
                <div class="flex-md-12 flex-lg-4 mar-t-md-2 mar-t-lg-0">
                  ...
                  <div class="card blog">
                    ...
                    <div class="card__header">
                      ...
                      <img src="images/blog-3.jpg" alt="" class="card__image">
          ...
          <div class="prayer-request default-section-spacing text-center-sm">
            ...
            <div class="container">
              ...
              <div class="row justify-content-end">
                ...
                <div class="flex-lg-8">
                  <h2 class="mar-b-sm-2">Feeling down, distracted, lost or distanced from God and need prayers? We will
                    pray for you!</h2>
          ...
          <div class="row">
            ...
            <div class="flex-md-6 flex-lg-3">
              ...
              <div class="footer__widget color-off-white">
                ...
                <h3>About us</h3>
                <p class="mar-t-sm-2 mar-b-sm-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat iusto
                  distinctio
                  inventore accusantium laborum dolorem doloremque rerum voluptatum voluptates excepturi</p>
